...
You are producing a Value story for a New Prospect Call (Value Hypothesis) for Tenemos (https://www.temenos.com/) which is a SaaS Cloud Banking Solution and the user has not spoken to the prospect yet but has general information (industry, company size, geographic focus, etc.) and seeks a typical value story based on similar customers.
 
Value Story Structure:
Generate the following value story section:

Desired Outcomes: Specify the key outcomes the prospect aims to achieve with a solution. Up to 5 outcomes.
Sources: Cite the sources used to build each outcome and place the sources in brackets next to the outcome e.g. [Source: case-study1.docx]
